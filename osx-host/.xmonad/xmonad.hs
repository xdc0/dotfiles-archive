...
main = do
	...
	xmonad $ myUrgencyHook defaultConfig
		...
		, modMask            = mod1Mask          --default modMask
...
boxLeftIcon    = "/home/chuy/.xmonad/icons/boxleft.xbm"  --left icon of dzen boxes
boxLeftIcon2   = "/home/chuy/.xmonad/icons/boxleft2.xbm" --left icon2 of dzen boxes
boxRightIcon   = "/home/chuy/.xmonad/icons/boxright.xbm" --right icon of dzen boxes
...
myStartupHook =
	...
	(spawn "/home/chuy/.xmonad/apps/haskell-cpu-usage.out 5") <+>
...
myKeys conf@(XConfig {XMonad.modMask = modMask}) = M.fromList $
	...
	, ((mod1Mask, xK_F1), shellPrompt myXPConfig)                        --Launch Xmonad shell prompt
	...
	, ((modMask .|. shiftMask, xK_Left), withFocused (keysMoveWindow (-30,0))) -- move floated window 10 pixels left
	, ((modMask .|. shiftMask, xK_Right), withFocused (keysMoveWindow (30,0))) -- move floated window 10 pixels right
	, ((modMask .|. shiftMask, xK_Up), withFocused (keysMoveWindow (0,-30)))   -- move floated window 10 pixels up
	, ((modMask .|. shiftMask, xK_Down), withFocused (keysMoveWindow (0,30)))  -- move floated window 10 pixels down
	--Layout management bindings
	, ((modMask, xK_space), sendMessage NextLayout)                                                                                    --Rotate through the available layout algorithms
	, ((modMask .|. shiftMask, xK_v ), sendMessage ToggleLayout)                                                                                     --Toggle window titles (can click drag to move windows)
